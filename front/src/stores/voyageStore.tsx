...
type VoyageState = 'ANCHORED' | 'SAILING' | 'PAUSED'
...
interface VoyageStore {
  ...
  completing: boolean
  cityArrival: { cityName: string; description: string; imageUrl: string } | null
  ...
  setCityArrival: (v: { cityName: string; description: string; imageUrl: string } | null) => void
}
